        ...
        <div class="home-header">
           ...
           <h2>Keep On Track With Us</h2>
            <div class="home-page-links">
                <router-link class="disable add-link" to="/book"><h3  class="add-link"  >BOOKS</h3><img src="img/library.png"  alt=""><span>Expand your horizons and get into an amazing world of adventures with your favorite books!</span></router-link>
